...
param_grid = {
    ...
    'logreg__tol': [1e-5, 1e-4, 1e-3, 0.1],
...
# EmoLex bei Staatsangehörigkeit 
#get_top_features_for_class(df, columns=emolex_columns, class_column='tn_staang_simplified', target_class='Deutsch / EU', top_n=10)
# germansentiment bei Bildungsinländer*innen 
#get_top_features_for_class(df, columns=germansentiment_columns, class_column='tn_aufenth_simplified', target_class='Bildungsinländer*innen', top_n=10)
# N-Gramme (Freuenzen) bei Bildungsinländer*innen
#ngram_columns_c = ngram_count_features.columns.tolist()
#get_top_num_features_for_class(df=df, columns=ngram_columns_c, class_column='tn_aufenth_simplified', target_class='Bildungsinländer*innen', top_n=10)
