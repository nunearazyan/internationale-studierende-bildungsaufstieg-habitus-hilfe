...
# Pipeline mit RandomUnderSampler + CB
# pipeline = Pipeline([
...
#     'catboost__depth': [7, 10, 16],
#     'catboost__iterations': [10, 50, 100, 300, 500, 1000],
#     'catboost__l2_leaf_reg': [2,10,20,30],
#     'catboost__min_data_in_leaf': [1, 2]
# }
...
# Optimale Parameter für Spracherwerb des Deutschen, TF-IDF des Tags <sek_habitus>
# pipeline = Pipeline([
#     ('under', RandomUnderSampler(random_state=42)),
#     ('randfor', CatBoostClassifier(
#         depth=10,
#         iterations=300,
#         l2_leaf_reg=20,
#         learning_rate=0.1,
...
# Optimale Parameter für Staatsangehörigkeit, TF-IDF des Tags <sek_habitus>
# pipeline = Pipeline([
#     ('under', RandomUnderSampler(random_state=42)),
#     ('randfor', CatBoostClassifier(
#         depth=7,
...
# Optimale Parameter für Aufenthaltsstatus, TF-IDF des Tags <sek_habitus>
# pipeline = Pipeline([
#     ('under', RandomUnderSampler(random_state=42)),
#     ('randfor', CatBoostClassifier(
#         depth=7,
...
# # Optimale Parameter für Migrant*innen erster Generation, TF-IDF des Tags <sek_habitus>
pipeline = Pipeline([
    ('under', RandomUnderSampler(random_state=42)),
    ('randfor', CatBoostClassifier(
        depth=7,
